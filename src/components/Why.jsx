    ...
    return (
        <div className="font-QuickSand font-semibold text-center">
            <div className="tracking-wide py-4 px-3 mt-10">
                <motion.h1 initial={{opacity: 0, y: 3}} whileInView={{opacity: 1, y:0}} transition={{ delay: 0.4, type: "spring", stiffness: 100}} viewport={{ once: true }}  className="text-3xl md:text-4xl pb-3 font-Karla px-10 md:px-0">WHY TECHNICIAN <span className="text-3xl md:text-4xl" style={{ color: 'red', }}>ondoor</span></motion.h1>
            ...
            <div className='w-100 flex flex-col py-5 space-y-7'>
                <div className="md:w-9/12 md:mx-auto md:flex md:justify-between md:space-x-5 space-y-10 md:space-y-0">
                    <motion.div initial={{ opacity:0, scale: 0.6 }} whileInView={{ opacity:1, scale: 1 }} transition={{ delay: 0.4, type: "tween", stiffness: 100}} viewport={{ once: true }}  className="w-[80%] mx-auto md:w-1/3 space-y-4 text-center px-8 py-4 ">
